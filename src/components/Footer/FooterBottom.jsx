    ...
    return (
        <div className={styles.bg}>
            ...
            <Container className={styles.container}>
                <span className={styles.logoAndCpr}>ZionBlog &copy; {year}. All rights reserved.</span>
                <SocialIcons />
            </Container>
        </div>
    );
...
export function SocialIcons() {
    return (
        <div className={styles.socialIcons}>
            ...
            <a href="https://www.linkedin.com/in/adebola-clement-961529251/" className={styles.socialLink} target="_blank" rel="noopener noreferrer"  aria-label="linkedin of the author">
                <FaLinkedinIn />
            </a>
            <a href="https://github.com/clementadebola/" className={styles.socialLink} target="_blank" rel="noopener noreferrer" aria-label="github">
                <FaGithub />
            </a>
        </div>
    );
